...
import { Badge, Field, Modal, Stat, StatSkeleton, TableSkeleton, Toggle, dateStr, money, statusTone, useSubmit } from '@/components/ui';
...
export default function AdminSchoolDetailPage() {
  ...
  if (!school) {
    return (
      <>
        <div className="topbar"><h1>School</h1></div>
